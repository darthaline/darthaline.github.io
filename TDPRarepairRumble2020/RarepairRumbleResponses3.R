...
data <- read.csv2 ('Rarepair Rumble Round 3.csv', header = TRUE, sep=',')
...
custompalette <- brewer.pal(n=7, name = 'Dark2')
display.brewer.pal(name = 'Dark2', n=7)

pdf(file='RRResults_3_bar_total.pdf', paper ='USr', width=11.69, height=8.27)
