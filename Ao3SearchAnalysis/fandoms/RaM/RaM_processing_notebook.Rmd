---
title: "Ao3 data analysis for Rick and Morty"
author: "darthaline"
date: "11 Aug 2020"
output:
  html_notebook:
...
Solid vertical lines on the graph indicate initial air dates, and dashed indicate final air dates, according to [Wiki article](https://en.wikipedia.org/wiki/Rick_and_Morty#Episodes).
...
seasonsStart <- c("2013-12-02", "2015-07-26", "2017-04-01", "2019-11-10")
seasonsStart <- as.Date(seasonsStart)
seasonsEnd <- c("2014-04-14", "2015-10-04", "2017-10-01", "2020-05-31")
...
Ao3 data analysis for Rick and Morty
