...
Plotting Complete Works and Works in Progress gives are similar overall shape to the total distribution, but with flatter bump around season 1 of LOK release and sharper new peak for Works in Progress. Speculatively, it's possible that a lot of works in progress were started a while back, but now, due to more free time authors have are updated, contributing to the dramatic 2020 peak.
...
rm(seasonsStartLOK, seasonsEndLOK,seasonsStart, seasonsEnd, plotDatesRatingDensity)
```
