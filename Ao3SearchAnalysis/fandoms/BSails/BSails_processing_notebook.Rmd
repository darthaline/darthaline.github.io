...
seasonsEnd <- c("2014-03-15", "2015-03-28", "2016-03-26", "2017-04-2")
...
* Works rated G are on average the shortest (~1500 words), followed by T (~4000 words), Not rated (~4500 words), E (~ 9000 words), and M (~11000 words). The trend of M rated works being the longest we observed in other fandoms holds here as well.
