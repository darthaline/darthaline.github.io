...
rm(rating, WIP, words, kudos, comments, bookmarks, hits)

```

# Engagement percentiles

Small cheat: all the numbers on the Y axis are increased by 1 to include the case of 0 into the plot (otherwise excluded because of log scale).
...
Top 10 of most prolific authors in the tag by the number of stories as of data collection date:

```{r authors, message = FALSE}
topList <- 30
...
Top 30 of the most popupar characters:
...
Top 30 of the most popupar relationships:
...
Top 30 of the most popupar freeform tags
